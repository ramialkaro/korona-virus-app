  ...
  return (
    <div className="container text-center">
      <div className="btn-group btn-group-toggle m-3" data-toggle="buttons">
        <button className="btn btn-outline-primary btn-lg" style={{ minWidth: '4rem' }} onClick={() => i18n.changeLanguage('en')}>en</button>
        <button className="btn btn-outline-info btn-lg" style={{ minWidth: '4rem' }} onClick={() => i18n.changeLanguage('ar')}>ع</button>
      </div>

      {
        i18n.use(LanguageDetector).language === 'ar' ?
          <div className="display-4 bg-dark text-info m-3 p-3 rounded">
